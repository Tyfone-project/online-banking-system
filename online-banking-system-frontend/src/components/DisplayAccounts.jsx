...
import accountHomeBackground from "../images/accountHomeBackground.png";
...
function DisplayAccounts() {
  ...
  const handleCreateAccount = (e) => {
    e.preventDefault();
    {
      if (accounts.length >= 5)
        ...
        toast.error("Cannot Add More Than Five Accounts");
  ...
  return (
    <>
      <div className="bg-image" style={{ height:"50%",backgroundImage: `url(${accountHomeBackground})`}}>
        <div
        ...
        {accounts.length > 0 ? (
          ...
          <h3 className="text-center">
            You have no accounts to display, click on below button to add an
            Account.
          </h3>
        )}
